import fs from 'fs';
let content = fs.readFileSync('src/pages/ExpenseCalculator.tsx', 'utf-8');
...
fs.writeFileSync('src/pages/ExpenseCalculator.tsx', replacement);
console.log("ExpenseCalculator updated");
